...
public class ClassroomDB extends AppCompatActivity{
    ...
    static final String DATABASE_CREATE =
            "create table " + DATABASE_TABLE + " (_id integer primary key autoincrement, "
                    + "sid text not null unique , subject text not null, prof text not null, time text not null, building text not null, classroom text not null, score text not null );";
    ...
    public Cursor getAllClassroom() {
        return db.query(DATABASE_TABLE, null, null, null, null, null, null);//select *
    }
    public Cursor getTime(String classroom) throws SQLException {
        Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] {
                        KEY_TIME, KEY_BUILDING }, KEY_CLASS + "=" + classroom,
    ...
    // ---retrieves all the Classroom---
    public Cursor getSid(String sidstr) {
        Cursor mCursor = db.query(DATABASE_TABLE, new String[] { KEY_ROWID, KEY_SID, KEY_SNAME, KEY_PNAME, KEY_TIME, KEY_BUILDING,
                KEY_CLASS }, KEY_SID+ "=" +sidstr, null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
        return mCursor;
    ...
    public Cursor getSidForGrade(String sidstr) {
        return db.query(DATABASE_TABLE, new String[] { KEY_ROWID, KEY_SNAME,KEY_SCORE }, KEY_SID+ "=" +sidstr, null, null, null, null);
    }
    public long insertContact(String sid, String sub,String prof, String time, String bd, String cl, String sc) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_SID, sid);
        initialValues.put(KEY_SNAME, sub);
        initialValues.put(KEY_PNAME, prof);
        ...
        initialValues.put(KEY_BUILDING, bd);
        initialValues.put(KEY_CLASS, cl);
        initialValues.put(KEY_SCORE, sc);
        return db.insert(DATABASE_TABLE, null, initialValues);
    }
}// class DBAdapter